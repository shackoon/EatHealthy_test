...
public class HeatChartSubFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_heat_chart, container, false);
        FindView(view);
        helper = new MyDBHelper(getContext());
        db = helper.getWritableDatabase();
        setBarChart(setBarDate_Heat(startDay, endDay));
        return view;
    }
    ...
    public ArrayList<BarEntry> setBarDate_Heat(String startDay, String endDay) {
        ...
        while (mDate1.compareTo(mDate2) < 0) {
            ...
            if (corsor.moveToNext()) {
                barEntries.add(new BarEntry(i, Float.parseFloat(corsor.getString(corsor.getColumnIndex(User_Nutritional_Goals.NOW_HEAT_COLUMN)))));
            } else {
    ...
    public void setBarChart(ArrayList<BarEntry> barEntries) {
        ...
        BarDataSet barDataSet = new BarDataSet(barEntries, "總熱量");
