...
import com.example.admin.eathealthy.Camera.PictureList;
...
public class Tab_Breakfast extends Fragment {
    ...
    public final static String TAB_BREAKFAST = "breakfast";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userTodayEat = new UserTodayEat(Account, TAB_BREAKFAST, getContext());
    ...
    public void setFoodRecyclerView(View view) {
        ...
        mRecyclerView.addOnItemTouchListener(new OnRecyclerItemClickListener(mRecyclerView) {
            ...
            public void onItemClick(RecyclerView.ViewHolder viewHolder) {
                ...
                trans_account.putString("select_time", TAB_BREAKFAST);
