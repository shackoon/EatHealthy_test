...
public class Tab_Other extends Fragment {
    ...
    public final static String TAB_OTHER = "other";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        userTodayEat = new UserTodayEat(Account, TAB_OTHER, getContext());
    ...
    public void setFoodRecyclerView(View view) {
        ...
        mRecyclerView.addOnItemTouchListener(new OnRecyclerItemClickListener(mRecyclerView) {
            ...
            public void onItemClick(RecyclerView.ViewHolder viewHolder) {
                ...
                trans_account.putString("select_time", TAB_OTHER);
        ...
        if (requestCode == ACTIVITY_START_CAMERA_APP && resultCode == RESULT_OK) {
            ...
            Tiny.getInstance().source(mImageFileLocation).asBitmap().withOptions(options).compress(new BitmapCallback() {
                ...
                public void callback(boolean isSuccess, Bitmap bitmap) {
                    ...
                    cv.put(User_Picture_Data.DINING_TIME_COLUMN, TAB_OTHER);
